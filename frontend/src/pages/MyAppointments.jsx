    ...
    <div>
      ...
      <div >
        {appointments.map((item, index) => (
          <div className='grid grid-cols-[1fr_2fr] gap-4 sm:flex sm:gap-6 py-2 border-b  hover:bg-gray-50' key={index}>
            <div>
            ...
            <div className='flex flex-col gap-2 items-center justify-center '>
              <div className='flex flex-col gap-2 justify-end  hover:bg-gray-100'>
                {/* Pay Online button: Only shown if appointment is NOT completed, NOT cancelled, and payment is pending */}
                ...
                {/* Cancel Appointment button: Only shown if appointment is NOT completed and NOT cancelled */}
                ...
                {/* Appointment Cancelled button: Shown only when appointment is cancelled but NOT completed */}
                ...
                {/* Completed button: Only shown when appointment is completed */}
                {item.isCompleted && (
